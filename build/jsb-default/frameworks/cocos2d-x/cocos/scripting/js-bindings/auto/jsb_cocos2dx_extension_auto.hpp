...
SE_DECLARE_FUNC(js_extension_Manifest_setPackageUrl);
...
SE_DECLARE_FUNC(js_extension_Manifest_setManifestUrl);
SE_DECLARE_FUNC(js_extension_Manifest_getSearchPaths);
SE_DECLARE_FUNC(js_extension_Manifest_isUpdating);
SE_DECLARE_FUNC(js_extension_Manifest_setVersionUrl);
...
SE_DECLARE_FUNC(js_extension_AssetsManagerEx_decompressLocalZip);
