...
static bool js_extension_Manifest_setPackageUrl(se::State& s)
{
    cocos2d::extension::Manifest* cobj = (cocos2d::extension::Manifest*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_extension_Manifest_setPackageUrl : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= seval_to_std_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_extension_Manifest_setPackageUrl : Error processing arguments");
...
SE_BIND_FUNC(js_extension_Manifest_setPackageUrl)
...
static bool js_extension_Manifest_setManifestUrl(se::State& s)
{
    cocos2d::extension::Manifest* cobj = (cocos2d::extension::Manifest*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_extension_Manifest_setManifestUrl : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= seval_to_std_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_extension_Manifest_setManifestUrl : Error processing arguments");
...
SE_BIND_FUNC(js_extension_Manifest_setManifestUrl)
...
static bool js_extension_Manifest_setVersionUrl(se::State& s)
{
    cocos2d::extension::Manifest* cobj = (cocos2d::extension::Manifest*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_extension_Manifest_setVersionUrl : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= seval_to_std_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_extension_Manifest_setVersionUrl : Error processing arguments");
...
SE_BIND_FUNC(js_extension_Manifest_setVersionUrl)
...
bool js_register_extension_Manifest(se::Object* obj)
{
    ...
    cls->defineFunction("setPackageUrl", _SE(js_extension_Manifest_setPackageUrl));
    ...
    cls->defineFunction("setManifestUrl", _SE(js_extension_Manifest_setManifestUrl));
    ...
    cls->defineFunction("setVersionUrl", _SE(js_extension_Manifest_setVersionUrl));
...
static bool js_extension_AssetsManagerEx_decompressLocalZip(se::State& s)
{
    cocos2d::extension::AssetsManagerEx* cobj = (cocos2d::extension::AssetsManagerEx*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_extension_AssetsManagerEx_decompressLocalZip : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 2) {
        ...
        ok &= seval_to_std_string(args[0], &arg0);
        ok &= seval_to_std_string(args[1], &arg1);
        SE_PRECONDITION2(ok, false, "js_extension_AssetsManagerEx_decompressLocalZip : Error processing arguments");
...
SE_BIND_FUNC(js_extension_AssetsManagerEx_decompressLocalZip)
...
bool js_register_extension_AssetsManagerEx(se::Object* obj)
{
    ...
    cls->defineFunction("decompressLocalZip", _SE(js_extension_AssetsManagerEx_decompressLocalZip));
